...
func (h *Handler) Confirm(c *gin.Context)    { httpx.NotImplemented(c) }
func (h *Handler) Cancel(c *gin.Context)     { httpx.NotImplemented(c) }
func (h *Handler) Reschedule(c *gin.Context) { httpx.NotImplemented(c) }
